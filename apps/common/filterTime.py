...
def filterTime(
    ...
    keyStart: Optional[str] = None, 
    keyEnd: Optional[str] = None, 
    maxDelta: Optional[Union[int, float]] = None, 
    unitDelta: Optional[Literal['days', 'day', 'hours', 'hour', 'minutes', 'minute', 'seconds', 'second', 'W', 'D', 'h', 'm', 's']] = None
) -> Union[bool, str]:
