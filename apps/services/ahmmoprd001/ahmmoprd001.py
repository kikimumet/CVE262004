    ...
    try:
        while True:
            ...
            if filter_cfg is None:
                ...
                break
            filter_wct, filter_technum, filter_params, api_url = filter_cfg
            logger.info(f"[{_SERVICE_NAME}] Filter diperbarui dari Oracle → wct={filter_wct}, technum={filter_technum}, params={filter_params}, api_url={api_url}")
